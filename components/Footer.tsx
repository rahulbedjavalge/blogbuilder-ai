      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-2xl font-bold text-white mb-4">BlogBuilder AI</h3>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="text-gray-300">AI Blog Generation</li>
              <li className="text-gray-300">Manual Blog Creation</li>
              <li className="text-gray-300">Blog Management</li>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © {new Date().getFullYear()} BlogBuilder AI. All rights reserved.
            </p>
